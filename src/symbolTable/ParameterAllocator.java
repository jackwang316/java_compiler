...
public class ParameterAllocator implements MemoryAllocator{
    ...
    public ParameterAllocator(MemoryAccessMethod accessor, String baseAddress, int startingOffset) {
    ...
    public ParameterAllocator(MemoryAccessMethod accessor,String baseAddress) {
	...
	public void restoreState() {
		...
		if (bookmarkIndex == 0) {
			...
			for (MemoryLocation mem : memoryLocations) {
				mem.addToOffset(maxAllocatedSize);
			}
		}
	}
}
